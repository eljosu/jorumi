 ...
 */
import { PlayerId, CharacterId, GhettoId, TileId, HexCoordinates, TileType, BuildingType, ResourceType, GamePhase } from '../domain/types';
...
export type GameAction = StartGameAction | EndTurnAction | AdvancePhaseAction | ExploreTileAction | PlaceTileAction | MoveCharacterAction | MoveAlienAction | GatherResourcesAction | ConsumeFoodAction | BuildStructureAction | HealWoundedAction | TransferResourcesAction | ConvertResourcesAction | AttackAlienAction | AttackMothershipAction | DefendAction | AlienAttackAction | AlienControlGhettoAction | AlienBombAction | AlienScanAction | ChangeRoleAction | ActivateBeaconAction | EscapeShipAction | EndGameAction;
